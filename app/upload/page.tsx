  ...
  const handleUpload = useCallback(async () => {
    ...
    try {
      ...
      if (!validateNoiseData(parsedData)) {
        throw new Error(
          "Invalid data format. Please check the template and try again."
        );
      }

      const existingData: NoiseDataEntry[] = JSON.parse(
        localStorage.getItem("noiseData") || "[]"
      );
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white mb-4">
            Upload Noise Pollution Data
          </h1>
          <p className="text-white/80 text-xl">
            Contribute to our database by uploading your noise pollution
            measurements
          </p>
        </div>
      </motion.div>
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select and upload your CSV file containing noise pollution data
              </CardDescription>
            </CardHeader>
              ...
              {success && (
                <Alert className="bg-green-50">
                  ...
                  <AlertDescription className="text-green-600">
                    Data uploaded successfully! Your data has been added to the
                    database.
                  </AlertDescription>
                </Alert>
              )}
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Please follow these guidelines to ensure your data is processed
                correctly
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <AccordionItem value="format">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-4 space-y-2">
                      ...
                      <li>
                        Required columns: id, name, type, lat, lng, date,
                ...
                <AccordionItem value="tips">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-4 space-y-2">
                      ...
                      <li>
                        Include the correct zone type (Commercial, Residential,
                        etc.)
                      </li>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="p-4 rounded-lg border bg-card text-card-foreground">
                ...
                <p className="text-sm text-muted-foreground">
                  Your data is automatically validated to ensure it meets the
              ...
              <div className="p-4 rounded-lg border bg-card text-card-foreground">
                ...
                <p className="text-sm text-muted-foreground">
                  Valid data is processed and integrated with existing
              ...
              <div className="p-4 rounded-lg border bg-card text-card-foreground">
                ...
                <p className="text-sm text-muted-foreground">
                  Your data becomes immediately available in the map and
                  analysis tools.
                </p>
              </div>
            </div>
